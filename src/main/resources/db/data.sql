...
-- 판매자 상품 테이블
insert into product_tb(name, price, qty, img_title, img_filename, created_at)
values ('바나나', 5000, 98, 'product.png', 'product.png', now());
insert into product_tb(name, price, qty, img_title, img_filename, created_at)
values ('딸기', 10000, 99, 'product.png', 'product.png', now());
insert into product_tb(name, price, qty, img_title, img_filename, created_at)
values ('수박', 10000, 100, 'product.png', 'product.png', now());